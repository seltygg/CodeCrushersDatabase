...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('accountid', models.OneToOneField(db_column='accountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.accounts')),
        ...
        migrations.CreateModel(
            name='Article',
            fields=[
                ('postid', models.OneToOneField(db_column='postid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.posts')),
        ...
        migrations.CreateModel(
            name='Bank',
            fields=[
                ('paymentid', models.OneToOneField(db_column='paymentid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.paymenttypes')),
        ...
        migrations.CreateModel(
            name='Choose',
            fields=[
                ('tagid', models.OneToOneField(db_column='tagid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.tags')),
            ],
            options={
                'db_table': 'choose',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Companies',
            fields=[
                ('companyaccountid', models.OneToOneField(db_column='companyaccountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.accounts')),
                ('companyname', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='Contain',
            fields=[
                ('fileid', models.OneToOneField(db_column='fileid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.certmaterials')),
            ],
            options={
                'db_table': 'contain',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Free',
            fields=[
                ('submodelid', models.OneToOneField(db_column='submodelid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.subscriptiontype')),
                ('subscriptiontype', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='GroupTags',
            fields=[
                ('groupid', models.OneToOneField(db_column='groupid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.groups')),
            ],
            options={
                'db_table': 'group_tags',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('useraccountid', models.OneToOneField(db_column='useraccountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.accounts')),
        ...
        migrations.CreateModel(
            name='ReactsTo',
            fields=[
                ('messageid', models.OneToOneField(db_column='messageid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.messages')),
            ],
            options={
                'db_table': 'reacts_to',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('settingid', models.OneToOneField(db_column='settingid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.settings')),
        ...
        migrations.CreateModel(
            name='Teach',
            fields=[
                ('teacherid', models.OneToOneField(db_column='teacherid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.teachers')),
            ],
            options={
                'db_table': 'teach',
                'managed': False,
        ...
        migrations.CreateModel(
            name='CompanyJobs',
            fields=[
                ('companyaccountid', models.OneToOneField(db_column='companyaccountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.companies')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Comprises',
            fields=[
                ('accountid', models.OneToOneField(db_column='accountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
            ],
            options={
                'db_table': 'comprises',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Connections',
            fields=[
                ('senderid', models.OneToOneField(db_column='senderid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
        ...
        migrations.CreateModel(
            name='Employees',
            fields=[
                ('employeeid', models.OneToOneField(db_column='employeeid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
        ...
        migrations.CreateModel(
            name='Employers',
            fields=[
                ('employerid', models.OneToOneField(db_column='employerid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
                ('companyname', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'employers',
        ...
        migrations.CreateModel(
            name='JobSeekers',
            fields=[
                ('jobseekerid', models.OneToOneField(db_column='jobseekerid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
        ...
        migrations.CreateModel(
            name='PostLikes',
            fields=[
                ('useraccountid', models.OneToOneField(db_column='useraccountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
        ...
        migrations.CreateModel(
            name='ViewsCount',
            fields=[
                ('viewedaccountid', models.OneToOneField(db_column='viewedaccountid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.individualusers')),
        ...
        migrations.CreateModel(
            name='Applications',
            fields=[
                ('applicationid', models.OneToOneField(db_column='applicationid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.jobseekers')),
        ...
        migrations.CreateModel(
            name='FillOut',
            fields=[
                ('applicationid', models.OneToOneField(db_column='applicationid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='dbConn.applications')),
                ('jobtitle', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'fill_out',
